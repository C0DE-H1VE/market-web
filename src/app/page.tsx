      ...
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start max-w-4xl">
        ...
        <div className="grid gap-6 md:grid-cols-2 w-full">
          <div className="p-6 border rounded-lg bg-white shadow-sm">
            <h3 className="text-xl font-semibold mb-4 text-gray-800">🚀 Stack Configurada</h3>
        ...
        <div className="w-full p-6 border rounded-lg bg-gray-50">
          <h3 className="text-xl font-semibold mb-4 text-gray-800">📁 Estrutura do Projeto</h3>
